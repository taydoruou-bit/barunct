 ...
 */
$config['site_title']                 = "POS SCODEWEB";       // Site Title, example.com This is not more functional
$config['admin_email']                = "scodeweb2016@gmail.com"; // Admin Email, admin@example.com This is not more functional
