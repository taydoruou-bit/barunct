...
abstract class REST_Controller extends \CI_Controller {
     ...
     * @var array
     */
    private $allowed_http_methods = ['get', 'delete', 'post', 'put', 'options', 'patch', 'head'];
