...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
				<a class="btn btn-primary btncls" href="<?= site_url('products/add_adjustment') ?>">
					<i class="fa fa-plus-circle"></i> <?= lang('add_adjustment') ?>
				</a>
				<a class="btn btn-primary btncls" href="<?= site_url('products/add_adjustment_by_csv') ?>">
					<i class="fa fa-plus-circle"></i> CSV
				</a>
				...
				<a class="btn btn-primary btncls" href="#" class="bpo" title="<b><?= $this->lang->line("delete_products") ?></b>"
    ...
    <div class="box-content no-padding-lhson">
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped no-print">
                        <thead>
                        <tr>
