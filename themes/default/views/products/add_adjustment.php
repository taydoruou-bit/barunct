...
<div class="box lhson_dieuchinh_add">
    ...
    <div class="box-header">
		...
		<div class="main-task-lhson">
			...
			<button type="submit" class="btn btn-primary btncls" name="add_adjustment" id="add_adjustment">
				<i class="fa fa-save"></i>
				Lưu
			</button>
			<button type="button" class="btn btn-danger btncls" id="reset">
            ...
            <div class="col-lg-12">                
                <div class="row">
                    <div class="col-lg-12 no-padding-lhson">						
							...
							<div class="col-md-12" id="sticker">
								<div class="form-group" style="margin-bottom:0;">
									<div class="input-group full-width">
										<?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="Thêm sản phẩm vào danh sách"'); ?>
									</div>
								</div>
						...
						<div class="col-lg-4 _dieuchinh_add">
							<?php if ($Owner || $Admin) { ?>
								<div class="col-md-4">
