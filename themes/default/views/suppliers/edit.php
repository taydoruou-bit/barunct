...
<div class="modal-dialog modal-lg lhson_add_biller">
    <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <?php echo form_input('nobandau', $supplier->nobandau, 'class="form-control" id="nobandau"'); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="modal-footer">
			<button type="submit" class="btn btn-primary btncls" name="edit_supplier" id="edit_supplier">
