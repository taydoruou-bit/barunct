    ...
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, {"mRender": currencyFormat}, null, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 6, filter_default_label: "[<?=lang('Nợ ban đầu');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">		
			<a class="btn btn-primary btncls" href="<?= site_url('suppliers/add'); ?>" data-toggle="modal" data-target="#myModal" id="add">
				<i class="fa fa-plus-circle"></i> <?= lang("add_supplier"); ?>
			</a>
			<a class="btn btn-primary btncls" href="<?= site_url('suppliers/import_csv'); ?>" data-toggle="modal" data-target="#myModal">
			...
			<a class="btn btn-primary btncls bpo" href="#" title="<b><?= $this->lang->line("delete_suppliers") ?></b>"
