...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('purchases_report'); ?> tổng quan<?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">				
				...
				<li class="dropdown"><a target="_blank" href="<?php echo site_url('reports/purchases_chitiet');?>" id="tongquan" class="tip" title="Báo cáo chi tiết"><i
