...
<script>
    $(document).ready(function () {
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getXuatXusReport/?v=1'.$v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
            <i class="fa-fw fa fa-cubes"></i>Báo cáo xuất xứ<?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/xuatxu"); ?>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("xuatxu", "xuatxu") ?>
                                <?php
                                $bt[''] = lang('select').' '.lang('xuatxu');
                                foreach ($xuatxu as $xt) {
                                    $bt[$xt->id] = $xt->name;
                                }
                                echo form_dropdown('xuatxu', $bt, (isset($_POST['xuatxu']) ? $_POST['xuatxu'] : ''), 'class="form-control select" id="xuatxu" placeholder="' . lang("select") . " " . lang("xuatxu") . '" style="width:100%"')
                                ?>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getXuatXusReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getXuatXusReport/0/xls/?v=1'.$v)?>";
            return false;
        });
