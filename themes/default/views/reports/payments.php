...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, {"mRender": ref}, {"mRender": ref},null,null, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bVisible": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('Nhân viên');?>]", filter_type: "text", data: []},
			{column_number: 4, filter_default_label: "[<?=lang('Kho');?>]", filter_type: "text", data: []},
			{column_number: 5, filter_default_label: "[<?=lang('purchase_ref');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('paid_by');?>]", filter_type: "text", data: []},
			{column_number: 7, filter_default_label: "[<?=lang('Số tiền');?>]", filter_type: "text", data: []},
