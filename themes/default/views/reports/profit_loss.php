            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <div class="small-box padding1010 bdarkGreen">
                                <h4 class="bold"><?= lang('payments_received'); echo " ".$this->sma->formatMoney($total_received->total_amount) ?> + Doanh thu khác: <?php echo $this->sma->formatMoney($total_thukhac->total_amount);?> </h4>
                                <i class="fa fa-usd"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_received->total_amount + $total_thukhac->total_amount) ?></h3>

                                <p class="bold"><?= $total_received->total . ' ' . lang('received') ?> + <?= $total_thukhac->total . ' thu khác';?> </p>

                                <p><?= $this->sma->formatMoney($total_received_cash->total_amount + $total_thukhac->total_amount) . ' ' . lang('cash') ?>
                        ...
                        <div class="col-sm-2">
                            <div class="small-box padding1010 bgrey">
                                <h4 class="bold">Thu hồi sản phẩm</h4>
                                <i class="fa fa-usd"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_returned->total_amount) ?></h3>

                                <p><?= $total_returned->total . ' Thu hồi '; ?></p>
                        ...
                        <div class="col-sm-2">
                            <div class="small-box padding1010 borange">
                                <h4 class="bold">Thanh toán nhập hàng</h4>
                                <i class="fa fa-usd"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_paid->total_amount) ?></h3>

                                <p><?= $total_paid->total . ' Chi nhập hàng'; ?></p>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bred">
                                <h4 class="bold">Lợi nhuận (Không thuế) + Doanh thu khác</h4>
                                <i class="fa fa-money"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_sales->total_amount - $total_purchases->total_amount + $total_thukhac->total_amount) ?></h3>

                                <p><?= $this->sma->formatMoney($total_sales->total_amount) . ' ' . lang('sales') ?>
                                    - <?= $this->sma->formatMoney($total_purchases->total_amount) . ' ' . lang('purchases') ?> + <?= $this->sma->formatMoney($total_thukhac->total_amount) . ' Thu khác'; ?></p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bpink">
                                <h4 class="bold">Lợi nhuận (Thuế bán hàng) + Doanh thu khác </h4>
                                <i class="fa fa-money"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney($total_sales->total_amount - $total_purchases->total_amount - $total_sales->tax + $total_thukhac->total_amount) ?></h3>
                        ...
                        <div class="col-sm-4">
                            <div class="small-box padding1010 bblue">
                                <h4 class="bold">Lợi nhuận (Thuế bán + nhập) + Doanh thu khác </h4>
                                <i class="fa fa-money"></i>

                                <h3 class="bold"><?= $this->sma->formatMoney(($total_sales->total_amount - $total_sales->tax) - ($total_purchases->total_amount - $total_purchases->tax) + $total_thukhac->total_amount) ?></h3>

                                <p>(<?= $this->sma->formatMoney($total_sales->total_amount) . ' ' . lang('sales') ?>
                                    - <?= $this->sma->formatMoney($total_sales->tax) . ' ' . lang('tax') ?>) -
                                    (<?= $this->sma->formatMoney($total_purchases->total_amount) . ' ' . lang('purchases') ?>
                                    - <?= $this->sma->formatMoney($total_purchases->tax) . ' ' . lang('tax') ?>) + <?= $this->sma->formatMoney($total_thukhac->total_amount) . ' Thu khác'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <div class="small-box padding1010 bmGreen">
                                ...
                                <h3 class="bold"><?= $this->sma->formatMoney($total_received->total_amount - $total_returned->total_amount - $total_paid->total_amount - $total_expenses->total_amount + $total_thukhac->total_amount) ; ?> </h3>

                                <p class="bold"><?= $this->sma->formatMoney($total_received->total_amount) . ' ' . lang('received') ?>
                                    - <?= $this->sma->formatMoney($total_returned->total_amount) . ' thu hồi '; ?>
                                    - <?= $this->sma->formatMoney($total_paid->total_amount) . ' chi nhập hàng' ?>
                                    - <?= $this->sma->formatMoney($total_expenses->total_amount) . ' ' . lang('expenses') ?> + <?= $this->sma->formatMoney($total_thukhac->total_amount) . ' Thu khác'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-4">
                        <div class="small-box padding1010 bblue">
                            ...
                            <?= $this->sma->formatMoney($warehouse_report['total_sales']->total_amount) . ' ' . lang('sales'); ?>
                                ...
                                <?= '<h3 class="bold">'.$this->sma->formatMoney($warehouse_report['total_doanhthu_khac']->total_amount).'</h3>'; ?>
                                <p>
                                <?= $warehouse_report['total_doanhthu_khac']->total.' Doanh thu khác'; ?>
                                </p>
