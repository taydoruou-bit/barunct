...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i>Báo cáo thu hồi công nợ <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
				...
				<li class="dropdown"><a target="_blank" href="<?php echo site_url('reports/thuhoicongnochitiet');?>" id="chitiet" class="tip" title="Báo cáo chi tiết"><i
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/baocaotralhson"); ?>
                    <div class="row">
                        <div class="col-sm-4">
