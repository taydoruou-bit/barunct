    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                <tr>
                    <td colspan="2">
                        <?php
                            ...
                            echo form_dropdown('warehouseln', $wh, (isset($_GET['warehouse']) ? $_GET['warehouse'] : $warehouse_id), 'class="form-control" id="warehouseln" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("warehouse") . '"');
                            ?>
                    </td>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4>Doanh thu khác:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->sma->formatMoney($thukhac->amount); ?></span></h4>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4>Nhập hàng:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $this->sma->formatMoney($costing->sales - $costing->cost - $discount - $expense + $thukhac->amount); ?></strong></span>
...
<script>
    $(document).ready(function() {
        $('#warehouseln').change(function(e) {
            var wh = $(this).val();
            $.get('<?=site_url('/reports/profit/')?><?=$date;?>/'+wh, function(data) {
