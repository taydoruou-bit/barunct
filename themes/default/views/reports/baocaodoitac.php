...
<script>
    $(document).ready(function () {
        oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getDoitacs') ?>',
            ...
            "aoColumns": [null, null, null, null,null,null, {
                ...
                "bSearchable": false
            },{"mRender": currencyFormat, "bSearchable": false}, {"mRender": currencyFormat, "bSearchable": false}, {"bSortable": false}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
				...
				nCells[7].innerHTML = currencyFormat(parseFloat(nobandau));
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Báo cáo đối tác'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
							...
							<th class="text-center"><?= lang("Dư nợ"); ?></th>
                            <th class="text-center"><?= lang("Nợ đầu kỳ"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getDoitacs/pdf')?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getDoitacs/0/xls')?>";
            return false;
        });
