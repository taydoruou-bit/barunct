...
<script>
    $(document).ready(function () {
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getNhomReport/?v=1'.$v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
            <i class="fa-fw fa fa-folder-open"></i><?= lang('Báo cáo nhóm sản phẩm'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/nhom"); ?>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('group_id', $cat, (isset($_POST['group_id']) ? $_POST['group_id'] : ''), 'class="form-control select" id="group_id" placeholder="' . lang("select") . " " . lang("Nhóm sản phẩm") . '" style="width:100%"')
                                ?>
                            </div>
                        </div>
