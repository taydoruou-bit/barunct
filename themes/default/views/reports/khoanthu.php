...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PhieuthuRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getKhoanThuReport/?v=1' . $v) ?>',
...
<div class="box no-print">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i>Danh sách các khoản thu
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getKhoanThuReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getKhoanThuReport/0/xls/?v=1'.$v)?>";
            return false;
        });
