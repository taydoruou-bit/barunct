    ...
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				var spl=aData[11].split("pay_");
				if(spl.length==2){
					nRow.id = spl[1];
					console.log(spl[1]);
					nRow.className = "payment_lhson";
				}else{
					nRow.id = aData[11];
            ...
            "aoColumns": [{"mRender": fld},null,null, null,null,null, null, {"mRender": currencyFormat},  {"mRender": paid_by},null, {"bSortable": false, "mRender": attachment}],
    ...
    <div class="box-header">
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?= site_url('purchases/add_expense') ?>" data-toggle="modal" data-target="#myModal">
				...
				<span class="text"> Thêm chi phí</span>
			</a>
		</div>	
    </div>
