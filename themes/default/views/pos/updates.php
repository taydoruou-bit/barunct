        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        if($pos_settings->purchase_code == 'purchase_code' || $pos_settings->scodeweb_username == 'scodeweb_username'){
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <?= lang('scodeweb_username', 'scodeweb_username'); ?>
                                <?= form_input('scodeweb_username', '', 'class="form-control tip" id="scodeweb_username"  required="required"'); ?>
                            </div>
                            <div class="form-group">
