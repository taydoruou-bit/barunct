...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
				<a class="btn btn-primary btncls" href="<?= site_url('billers/add'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_biller"); ?>
			   </a>
				...
				<a class="btn btn-primary btncls bpo" href="#" title="<b><?= $this->lang->line("delete_billers") ?></b>"
