...
<div class="modal-dialog" style="width:<?php echo $kich_thuoc;?>">	
	<?php $attrib = array();
        echo form_open("quotes/printbaogia/" . $id, $attrib); ?>
    <div class="modal-content">
        <div class="modal-header no-print header_lhson_print">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-2x">&times;</i>
            </button>
			 <button type="button" name="printsalelhson" onclick="inhoadon_set()" class="btn btn-primary"><i class="fa fa-print"></i> In Báo giá</button>
            <h4 class="modal-title" id="myModalLabel"><?php echo "In Báo Giá"; ?></h4>
        </div>
