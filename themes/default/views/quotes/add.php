...
<script type="text/javascript">
    ...
    var customColumns = [];
    $(document).ready(function() {
        // Load existing custom columns from database when page loads
        $.ajax({
            type: 'GET',
            url: '<?= site_url("quotes/get_custom_columns") ?>',
            dataType: 'json',
            async: true, // ← ĐỔI THÀNH TRUE
            success: function(existingColumns) {
                ...
                if (existingColumns && existingColumns.length > 0) {
                    ...
                    // Populate modal with existing columns
        ...
        $(document).on('input', '.custom-field-input', function() {
            ...
            // ✅ LOẠI BỎ [] khỏi tên field trước khi lưu
            ...
            quitems[item_id].custom_fields[cleanField] = value; // ← Lưu bằng cleanField
...
<div class="box">
    ...
    <div class="box-header">
        ...
        <div class="main-task-lhson nhapkho">
            ...
            <button type="submit" class="btn btn-primary btncls" name="add_quote" id="add_quote">
                <i class="fa fa-save"></i>
                Thêm
            </button>
            <button type="submit" class="btn btn-success btncls" name="add_quote_view" id="add_quote_view">
                <i class="fa fa-eye"></i>
                Lưu & xem báo giá
            </button>
...
<div class="modal" id="customOptionsModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="form-group custom-field-row">
        <label class="col-sm-4 control-label">Tên trường</label>
        <div class="col-sm-7">  <!-- ĐỔI từ col-sm-8 thành col-sm-7 -->
            <input type="text" class="form-control custom-field-name" placeholder="Ví dụ: Màu sắc, Kích thước...">
        </div>
        <!-- THÊM ĐOẠN NÀY -->
        <div class="col-sm-1">
