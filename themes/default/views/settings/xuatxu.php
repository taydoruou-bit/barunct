...
<script>
    $(document).ready(function () {
        oTable = $('#BrandTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getXuatxu') ?>',
...
<?= form_open('system_settings/xuatxu_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-th-list"></i>Xuất xứ</h2>

        
		<div class="main-task-lhson">
				<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_xuatxu'); ?>" data-toggle="modal" data-target="#myModal">
					<i class="fa fa-plus"></i> <?= lang('add_xuatxu') ?>
				</a>
