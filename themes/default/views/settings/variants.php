...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_variant'); ?>"
                                        data-toggle="modal" data-target="#myModal"><i class="icon fa fa-plus"></i> Thêm</a>
		</div>	
    </div>
