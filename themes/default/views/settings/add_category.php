    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group" id="category_select_container">
                ...
                <?php
                $cat['0'] = lang('select').' '.lang('parent_category');
                foreach ($categories as $pcat) {
                    $cat[$pcat->id] = $pcat->name;
                }
                echo form_dropdown('parent[]', $cat, (isset($_POST['parent']) ? $_POST['parent'] : '0'), 'class="form-control select" id="parent" place_holder="Chọn danh mục" data-select-id="0" style="width:100%" onchange="get_subcategories(this.value,0)" ')
                ?>
            </div>
...
<script>
    ...
    function get_subcategories(category_id, data_select_id) {
        ...
        if (subcategories.length > 0) {
            ...
            var select_tag = '<select class="form-control subcategory-select" data-select-id="' + new_data_select_id + '" name="parent[]" onchange="get_subcategories(this.value,' + new_data_select_id + ');">' +
