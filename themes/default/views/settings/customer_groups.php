...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
				<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_customer_group'); ?>" data-toggle="modal"
			   ...
			   <a class="btn btn-primary btncls" href="#" id="excel" data-action="export_excel"><i
				...
				<a class="btn btn-primary btncls" href="#" id="delete" data-action="delete"><i
