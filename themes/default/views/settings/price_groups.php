...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			   <a class="btn btn-primary btncls" title="<?= lang('add_price_group') ?>" class="tip" href="<?php echo site_url('system_settings/add_price_group'); ?>" data-toggle="modal" data-target="#myModal">
