...
<script>
    $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, null, null, {"bVisible": false, "mRender": null}, {"bVisible": false, "mRender": null}, {"bSortable": false}]
        });
    });
</script>
...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			  <a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_unit'); ?>" data-toggle="modal" data-target="#myModal">
