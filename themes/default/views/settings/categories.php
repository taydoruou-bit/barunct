...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_category'); ?>" data-toggle="modal" data-target="#myModal">
				<i class="fa fa-plus"></i> <?= lang('add_category') ?>
			</a>
			<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/import_categories'); ?>" data-toggle="modal" data-target="#myModal">
