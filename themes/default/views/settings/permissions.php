                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="products-giasi" class="checkbox" name="products-giasi" <?php echo $p->{'products-giasi'} ? "checked" : ''; ?>>
                                        <label for="products-giasi" class="padding05"><?= lang('Giá sỉ') ?>
                                               </label>
								...
								<tr>
                                    <td>Phiếu chi</td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="chi-index" <?php echo $p->{'chi-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="chi-add" <?php echo $p->{'chi-add'} ? "checked" : ''; ?>>
										
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="chi-edit" <?php echo $p->{'chi-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="chi-delete" <?php echo $p->{'chi-delete'} ? "checked" : ''; ?>>
                                    </td>
                                </tr>
							<tr>
                                    <td>Phiếu thu</td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="thu-index" <?php echo $p->{'thu-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="thu-add" <?php echo $p->{'thu-add'} ? "checked" : ''; ?>>
										
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="thu-edit" <?php echo $p->{'thu-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="thu-delete" <?php echo $p->{'thu-delete'} ? "checked" : ''; ?>>
                                    </td>
                                </tr>	
                                <tr>
                                    <td><?= lang("reports"); ?></td>
                                    <td colspan="5">
                                        ...
                                        <span style="inline-block">
                                            ...
                                            <label for="expenses" class="padding05">Thu - chi</label>
                                        </span>
                                        <span style="inline-block">
