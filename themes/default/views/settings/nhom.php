...
<script>
    $(document).ready(function () {
        oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getNhom') ?>',
...
<?= form_open('system_settings/nhom_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('Nhóm sản phẩm'); ?></h2>

       
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?php echo site_url('system_settings/add_nhom'); ?>" data-toggle="modal" data-target="#myModal">
				<i class="fa fa-plus"></i> <?= lang('Thêm nhóm') ?>
			</a>
