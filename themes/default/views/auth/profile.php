...
<div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
						...
						<div class="main-task-lhson">
							<button type="submit" class="btn btn-primary btncls" name="update" id="update">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-lg-12">                                
                                <div class="row">
                                    <div class="col-md-12">
										<div class="col-md-6 lhson_profile_edit">
											<div class="col-md-4">
										...
										<div class="col-md-5 col-md-offset-1 lhson_profile_edit">
											<div class="col-md-4">
												<?php if ($Owner && $id != $this->session->userdata('user_id')) { ?>
																	...
																	<div class="col-md-12">
																		<div class="col-md-12">
																			...
																			<div class="form-group">
																				...
																				echo form_dropdown('new_permission[]', $gp2,'', 'id="new_permission" multiple class="form-control select2" style="width:100%;"');
																				?>
																			</div>
																			...
																			<div class="no">
																				...
																				<div class="form-group">
																					...
																					echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $user->warehouse_id), 'required id="warehouse" class="form-control select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" style="width:100%;" ');
																					?>
																				</div>
																				<div class="form-group">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
						...
						<div class="main-task-lhson nhapkho">
							<button type="submit" class="btn btn-primary btncls" name="change_password" id="change_password">
								<i class="fa fa-save"></i>
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        <h2 class="blue"><i class="fa-fw fa fa-file-picture-o nb"></i><?= lang('change_avatar'); ?></h2>
							...
							<div class="main-task-lhson nhapkho">
								<button type="submit" class="btn btn-primary btncls" name="update_avatar" id="update_avatar">
									<i class="fa fa-save"></i>
									<?php echo lang('update_avatar');?>
								</button>
								<button type="button" class="btn btn-default btncls" id="reset">
									<i class="fa fa-refresh"></i>
									<?= lang('reset') ?>
    ...
    <script>
        $(document).ready(function () {
            $('#change-password-form').bootstrapValidator({
                message: 'Vui lòng cung cấp giá trị',
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function () {
            ...
            $('#new_permission').val([<?=implode(",", json_decode($user->new_permission));?>]).change();
        });
    </script>
<?php } ?>
