...
<div class="box">
    ...
    <div class="box-header">
		...
		<div class="main-task-lhson nhapkho">
			<button type="submit" class="btn btn-primary btncls" name="add_user" id="add_user">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">                
                <div class="row">
                    <div class="col-md-12">
						<div class="col-md-5 col-md-offset-1 lhson_add_user">
							<div class="col-md-4">
								...
								<div class="form-group">
									<?= lang("Phần quyền thêm", "new_permission"); ?>
									
								</div>
								<div class="form-group">
									<?php
									foreach ($groups as $group) {
										if (!in_array($group['name'],['customer','supplier','admin','owner'])) {
											$gp2[$group['id']] = $group['description'];
										}
									}
									echo form_dropdown('new_permission[]', $gp2, (isset($_POST['new_permission']) ? $_POST['new_permission'] : ''), 'id="new_permission" multiple class="form-control select2" style="width:100%;"');
									?>
								</div>
								...
								<div class="no">
									...
									<div class="form-group">
										...
										echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ''), 'id="warehouse" required="required" class="form-control select" style="width:100%;" ');
										?>
									</div>
                        ...
                        <div class="col-md-6 lhson_add_user">
							<div class="col-md-4">
								<div class="form-group">
								...
								<div class="form-group _gioitinh_add_user">
									<?= lang('gender', 'gender'); ?>
									<?php
								...
								<div class="form-group">
									...
									<div class="controls">
										<?php echo form_password('password', '', 'class="form-control tip" autocomplete="new-password" id="password" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" data-bv-regexp-message="'.lang('pasword_hint').'"'); ?>
								...
								<div class="form-group">
									...
									<div class="controls">
										<?php echo form_password('confirm_password', '', 'class="form-control" autocomplete="new-password" id="confirm_password" required="required" data-bv-identical="true" data-bv-identical-field="password" data-bv-identical-message="' . lang('pw_not_same') . '"'); ?>
									</div>
								</div>
