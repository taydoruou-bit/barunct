<script>
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            {column_number: 1, filter_default_label: "[<?=lang('first_name');?> <?=lang('last_name');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?= site_url('auth/create_user'); ?>">
				<i class="fa fa-plus-circle"></i> <?= lang("add_user"); ?></a>
		   <a class="btn btn-primary btncls" href="#" id="excel" data-action="export_excel"><i
						class="fa fa-file-excel-o"></i> Excel</a>
		  <a class="btn btn-primary btncls" href="#" id="pdf" data-action="export_pdf"><i
			...
			<div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('first_name'); ?> <?=lang('last_name');?></th>
