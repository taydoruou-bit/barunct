...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("purchases/add_payment_lhson/", $attrib); ?>
            ...
            <div class="row">
				<div class="col-md-12 _ncc_add_lhsonv2">
					<div class="form-group">
							...
							echo form_dropdown('supplier_id', $wh,'', 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("supplier") . '" required="required" style="width:100%;" ');
							?>
					</div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_payment_lhson', lang('add_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
