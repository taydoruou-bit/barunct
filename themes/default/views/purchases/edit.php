...
<div class="box lhson_nhapkho_add">
    ...
    <div class="box-header">
		...
		<div class="main-task-lhson nhapkho">
			<button type="submit" class="btn btn-primary btncls" name="edit_pruchase" id="edit_pruchase">
						...
						<div class="col-lg-4">	
							...
							<div class="col-md-4">
								<div class="form-group" id="div_doitac_id">
                                    ...
                                    echo form_dropdown('doitac', $dt, (isset($_POST['doitac']) ? $_POST['doitac'] : $purchase->doitac), 'id="doitac" data-placeholder="' . lang("select") . ' ' . lang("doitac") . '" class="form-control input-tip select" style="width:100%;"');
                                    ?>
								</div>
							</div>
							<div class="col-md-4">
