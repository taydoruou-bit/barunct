...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
				<div class="col-md-12 _ncc_add_lhsonv2">
						<div class="form-group">
								...
								echo form_dropdown('supplier_id', $wh,(isset($_POST['supplier_id']) ? $_POST['supplier_id'] : $payment->id_ncc_id_kh), 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("supplier") . '" required="required" style="width:100%;" ');
								?>
						</div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by" required="required">
                                            <?= $this->sma->paid_opts_lhson($payment->paid_by, true); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
