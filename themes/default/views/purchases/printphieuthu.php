    ...
    <div class="modal-content">
        <div class="modal-header no-print header_lhson_print">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-2x">&times;</i>
			 ...
			 <button type="button" name="printphieuchi" onclick="inhoadon_set()" class="btn btn-primary"><i class="fa fa-print"></i> In Phiếu Thu</button>
            <h4 class="modal-title" id="myModalLabel">In Phiếu Thu</h4>
        </div>
