...
<div class="modal-dialog" style="width:<?php echo $kich_thuoc;?>">	
	<?php $attrib = array();
        echo form_open("purchases/printnhap/" . $id, $attrib); ?>
    <div class="modal-content">
        <div class="modal-header no-print header_lhson_print">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-2x">&times;</i>
            </button>
			 <button type="button" name="printnhap" onclick="inhoadon_set()" class="btn btn-primary"><i class="fa fa-print"></i> In hóa đơn</button>
            <h4 class="modal-title" id="myModalLabel"><?php echo $status=='returned'?'Print hóa đơn trả hàng NCC':lang('Print hóa đơn nhập hàng'); ?></h4>
        </div>
