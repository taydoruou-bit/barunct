                ...
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
                        <tr>
							...
							if ($Settings->chiec_khau) {
                                echo '<td style="width: 100px; text-align:right; vertical-align:middle;">' . ($row->chiec_khau != 0 ? '<small>(' . $row->chiec_khau . ')</small> ' : '') . $this->sma->formatMoney($row->items_chiec_khau) . '</td>';
                            }
                            ?>
