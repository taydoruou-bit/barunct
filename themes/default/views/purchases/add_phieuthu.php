...
<div class="modal-dialog lhson_add_address">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_phieuthu'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("purchases/add_phieuthu", $attrib); ?>
        <div class="modal-body">
			...
			<div class="form-group" id="div_khohang" style="display:none">
                <?= lang("warehouse", "warehouse_add_phieuthu"); ?>
                <?php
                ...
                echo form_dropdown('warehouse', $wh, $selected, 'id="warehouse_add_phieuthu" class="form-control input-tip select" style="width:100%;" required="required" ');
                ?>
            </div>
			<div class="form-group">
        ...
        <div class="modal-footer">
			<button type="submit" class="btn btn-primary btncls" name="add_phieuthu" id="add_phieuthu">
...
$(document).ready(function() {
	...
	function loadobjlhson(){
		...
		if(selected==3){
			...
			jQuery("#warehouse_add_phieuthu").removeAttr("required");
			jQuery("#warehouse_add_phieuthu").prop('required',false);	
			...
			jQuery("#div_khohang").css("display","none");
			jQuery("#warehouse_add_phieuthu").attr("required","required");
