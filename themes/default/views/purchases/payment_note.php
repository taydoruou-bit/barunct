        ...
        <div class="modal-body print">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p style="font-weight:bold;"><?= lang("purchase").' '.lang('ref'); ?>: <?= isset($inv)?$inv->reference_no:""; ?></p>
            ...
            <div class="row">
				...
				<div class="col-sm-4 pull-right">
					<?php 
					$url_edit=site_url('purchases/edit_payment/'.$payment->id);
					$url_xoa=site_url('purchases/delete_payment/'.$payment->id);
					if(!$inv){
						$url_edit=site_url('purchases/edit_payment_lhson/'.$payment->id);
						$url_xoa=site_url('purchases/delete_payment_lhson/'.$payment->id);
					}
					?>
					<a class="button" href="<?= $url_edit ?>" 
						data-toggle="modal" data-target="#myModal2">
						<i class="fa fa fa-edit"></i><span class="text"> <?= lang('edit_payment'); ?></span>
					</a>&nbsp;&nbsp; | &nbsp;&nbsp;
					<a href="#" class="po" title="<b>Xóa thanh toán</b>" data-content="<p>Bạn có chắc không?</p><a class='btn btn-danger' id='26' href='<?= $url_xoa ?>'>Vâng tôi chắc chắn</a> <button class='btn po-close'>Không</button>" rel="popover"><i class="fa fa-trash-o"></i>Xóa</a>
