...
<script>
    $(document).ready(function () {
        oTable = $('#TOData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld},null, null,null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    tax += parseFloat(aaData[aiDisplay[i]][8]);
                    gtotal += parseFloat(aaData[aiDisplay[i]][9]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[7].innerHTML = currencyFormat(formatMoney(row_total));
                nCells[8].innerHTML = currencyFormat(formatMoney(tax));
                nCells[9].innerHTML = currencyFormat(gtotal);
            }
...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?= site_url('transfers/add') ?>">
			...
			<a class="btn btn-primary btncls bpo" href="#" title="<b><?= $this->lang->line("delete_transfers") ?></b>"
