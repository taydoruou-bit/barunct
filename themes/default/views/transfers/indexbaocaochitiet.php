...
<script>
    $(document).ready(function () {		
        ...
        oTable = $('#TODataBC').dataTable({
            ...
            'sAjaxSource': '<?= site_url('transfers/getTransfersBaoCaoChiTiet?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld},null, null,null, null, null,null,null,{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": row_status}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var sl = 0, tt = 0, phi = 0, tc=0;
                for (var i = 0; i < aaData.length; i++) {
                    sl += parseFloat(aaData[aiDisplay[i]][8]);
                    tt += parseFloat(aaData[aiDisplay[i]][10]);
                    phi += parseFloat(aaData[aiDisplay[i]][11]);
					tc += parseFloat(aaData[aiDisplay[i]][12]);
				
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[8].innerHTML = currencyFormat(sl);
                nCells[10].innerHTML = currencyFormat(tt);
                nCells[11].innerHTML = currencyFormat(phi);
				nCells[12].innerHTML = currencyFormat(tc);
            }
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star-o"></i>Báo cáo <?= lang('transfers'); ?> Chi tiết</h2>
		...
		<div class="box-icon">
            <ul class="btn-tasks">
				...
				<li class="dropdown"><a target="_blank" href="<?php echo site_url('transfers/baocaochuyen');?>" id="tongquan" class="tip" title="Báo cáo tổng quan"><i
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				<div id="form">
				<?php echo form_open("transfers/baocaochuyenchitiet"); ?>
						<div class="row">
							<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('transfers/getTransfersBaoCaoChiTiet/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('transfers/getTransfersBaoCaoChiTiet/0/xls/?v=1'.$v)?>";
            return false;
        });
