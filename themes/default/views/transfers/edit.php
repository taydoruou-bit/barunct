...
$('#doitac').select2({
		...
		if(1==<?php echo (int)$transfer->doitac>0?1:0;?>){
			...
			localStorage.setItem('doitac', '<?= $transfer->doitac ?>');
...
<div class="box">
    ...
    <div class="box-header">
		...
		<div class="main-task-lhson nhapkho">
			<button type="submit" class="btn btn-primary btncls" name="edit_transfer" id="edit_transfer">
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4 lhson_chuyenkho_add">
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group" id="div_doitac_id">
									<?= lang("Đối tác giao hàng", "doitac"); ?>
										...
										<?php
										echo form_input('doitac', (isset($_POST['doitac']) ? $_POST['doitac'] : $transfer->doitac), 'id="doitac" data-placeholder="' . lang("select") . ' ' . lang("đối tác") . '" class="form-control input-tip" style="width:100%;"');
										?>
								</div>
							</div>
							<div class="col-md-4">
