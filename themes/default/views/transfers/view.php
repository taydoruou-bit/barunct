                ...
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tr>
                        ...
                        <?php if ($Settings->tax1) {
                            echo '<th style="text-align:center; vertical-align:middle;">Thuế</th>';
                        } ?>
                    ...
                    if ($Settings->tax1) {
					 ...
					 <tr>
						<td colspan="<?= $col+1; ?>"
							style="text-align:right; padding-right:10px;">Phí vận chuyển
							(<?= $default_currency->code; ?>)
						</td>
						<td style="text-align:right; padding-right:10px;"><?= $this->sma->formatMoney($transfer->shipping); ?>
					</tr>	
                    <tr>
                        <td colspan="<?= $col+1; ?>"
