...
<script type="text/javascript" src="<?= $assets ?>js/khuyenmainew.js"></script>
<script type="text/javascript">
	...
	var $mainproduct = $('#pomain_product');
    $(document).ready(function () {
		
        $mainproduct.change(function (e) {
			localStorage.setItem('pomain_product', $(this).val());
			$('#main_product').val($(this).val());
		});
				
		nsProducts();
		function nsProducts() {
			$('#pomain_product').select2({
				minimumInputLength: 1,
				ajax: {
					url:"<?php echo base_url();?>khuyenmai/suggestionsProducts",
					dataType: 'json',
					quietMillis: 15,
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('khuyenmai_add') ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("khuyenmai/addnew", $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label for="qudiscount"><?= lang('khuyenmai_start') ?></label>
								<?php echo form_input('startdate', (isset($_POST['startdate']) ? $_POST['startdate'] : ""), 'class="form-control input-tip datetime" id="startdate" required="required"'); ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="qudiscount"><?= lang('khuyenmai_end') ?></label>
								<?php echo form_input('enddate', (isset($_POST['enddate']) ? $_POST['enddate'] : ""), 'class="form-control input-tip datetime" id="enddate" required="required"'); ?>
							</div>
						</div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="qudiscount"><?= lang('khuyenmai_event') ?></label>
                                <?php echo form_input('tenevent', (isset($_POST['tenevent']) ? $_POST['tenevent'] : $qunumber), 'class="form-control input-tip" id="quref"'); ?>
                            </div>
                        </div>
						...
						<div class="col-md-12" id="stickermain">
                            <div class="well well-sm">
								<div class="col-md-8">
									<div class="form-group" style="margin-bottom:0;">
										<div class="input-group wide-tip">
										 <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
												Sản phẩm chính</a></div>
											<input type="hidden" name="main_product" value="" id="pomain_product"
								...
								<div class="col-md-4">
									<div class="form-group" style="margin-bottom:0;">
										<div class="input-group wide-tip">
										 <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
												Số lượng</a></div>
											<?php echo form_input('main_quantity', '', 'class="form-control" id="main_quantity" placeholder="'.lang('Số lượng tối đa để được khuyến mãi').'"'); ?>
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="'.lang('Thêm sản phẩm khuyến mãi kèm sản phẩm chính').'"'); ?>
                                ...
                                <div class="controls table-controls">
                                    <table id="quTable"
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                echo '<th class="col-md-1">'.lang('Số lượng KM').'</th>';                                            
                                            ?>
                        ...
                        <div class="col-sm-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_khuyenmai', $this->lang->line("submit"), 'id="add_quote" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
