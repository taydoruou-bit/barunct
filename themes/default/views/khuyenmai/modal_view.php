            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        <th style="width:120px;"><?= lang("khuyenmai_price"); ?></th>
                        <th style="width:120px;"><?= lang("khuyenmai_discount"); ?></th>                        
                    </tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:right; width:100px;"><?= $this->sma->formatMoney($row->giakhuyenmai); ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= site_url('khuyenmai/edit/' . $inv->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
