...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		<?php if ($inv) { ?>
		localStorage.setItem('pomain_product', '<?php echo $inv->main_product_id;?>');
		
			$.ajax({
					url: '<?= site_url('products/cgetProductByID/') ?><?php echo $inv->main_product_id;?>',
					type: 'get',
					dataType: 'json',
					...
					success: function (ketqua) {
						...
						if(ketqua!=null){							
							$('#pomain_product').select2('data', {id:'<?php echo $inv->main_product_id;?>',text:ketqua});
						}
					}
			});
		<?php } ?>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("khuyenmai/editnew/" . $id, $attrib)
                ?>
								...
								<div class="col-md-4">
									<div class="form-group" style="margin-bottom:0;">
										<div class="input-group wide-tip">
										 <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
												Số lượng</a></div>
											<?php echo form_input('main_quantity', $inv->main_quantity, 'class="form-control" id="main_quantity" placeholder="'.lang('Số lượng tối đa để được khuyến mãi').'"'); ?>
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="' . $this->lang->line("Thêm sản phẩm khuyến mãi kèm sản phẩm chính") . '"'); ?>
