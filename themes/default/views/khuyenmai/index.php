...
<script>
    $(document).ready(function () {
        oTable = $('#QTABLEKM').dataTable({
            "aaSorting": [[1, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('khuyenmai/getKhuyenmais'. ($warehouse_id ? '/' . $warehouse_id : '')) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.id = aData[0];
                nRow.className = "khuyenmai_link";
                return nRow;
            },
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld},null,null,null, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
...
<div class="box">
    ...
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?=lang('khuyenmai_header') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
        ...
        <div class="main-task-lhson">
            ...
            <a class="btn btn-primary btncls" href="<?= site_url('khuyenmai/add') ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="QTABLEKM" class="table table-bordered table-hover table-striped">
                        <thead>
                        <tr class="active">
