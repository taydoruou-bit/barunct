...
<div class="modal-dialog modal-lg lhson_add_biller">
    <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group person">
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input skip" <?=$chloai1;?> type="radio" name="loaikhach" id="inlineRadiol1" value="1">
                          <label class="form-check-label" for="inlineRadio1">Cá Nhân</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input skip" <?=$chloai0;?> type="radio" name="loaikhach" id="inlineRadiol2" value="0">
                   ...
                   <div class="form-group gioitinh">
                        ...
                        if ($customer->gioitinh==0) {
                         ...
                         ?>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input skip" <?=$chgt1;?> type="radio" name="gioitinh" id="inlineRadio1" value="1">
                          <label class="form-check-label" for="inlineRadio1">Nam</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input skip" <?=$chgt0;?> type="radio" name="gioitinh" id="inlineRadio2" value="0">
                    ...
                    <div class="form-group ngaysinh">
                        ...
                        <?php
                         ...
                         echo form_input('ngaysinh', $ngaysinh, 'class="form-control date skip" place_holder="Ngày-tháng-năm" id="ngaysinh" required="required" autocomplete="off"'); ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('address', $customer->address, 'class="form-control" required="required" id="address"'); ?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php echo form_input('facebook', $customer->facebook, 'class="form-control" id="facebook"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf1", "cf1"); ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <?= lang("Ghi chú", "cf5"); ?>
                        <textarea id="ghichu" name="ghichu" class="skip"><?=$customer->ghichu;?></textarea>

                    </div>
					<div class="form-group">
                        <?= lang("Nợ ban đầu", "nobandau"); ?>
                        <?php echo form_input('nobandau', $customer->nobandau, 'class="form-control" id="nobandau"'); ?>
                    </div>
					<div class="form-group">
        ...
        <div class="modal-footer">
			<button type="submit" class="btn btn-primary btncls" name="edit_customer" id="edit_customer">
...
<script type="text/javascript">
    $(document).ready(function (e) {
        $("#ngaysinh").datetimepicker({
                ...
                showClose:true,
                pickTime: false
        }).datetimepicker('update','<?=$ngaysinh;?>');
