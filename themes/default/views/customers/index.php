    ...
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender":null,"bVisible": false}, null, null, null, null, null, null, {"mRender": currencyFormat,"bVisible": true}, null,{"mRender": currencyFormat,"bSearchable": false,"bSortable": false}, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 9, filter_default_label: "[Dư nợ]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		...
		<div class="main-task-lhson">
				<a class="btn btn-primary btncls" href="<?= site_url('customers/add'); ?>" data-toggle="modal" data-target="#myModal" id="add">
					<i class="fa fa-plus-circle"></i> <?= lang("add_customer"); ?>
				</a>
				<a class="btn btn-primary btncls" href="<?= site_url('customers/import_xls'); ?>" data-toggle="modal" data-target="#myModal">
					<i class="fa fa-plus-circle"></i> <?= lang("Import xls"); ?>
				</a>
			<?php if ($Owner) { ?>
