							...
							<?php } ?>
							 <div class="col-md-4">
								<div class="form-group" id="div_doitac_id">
                                    ...
                                    echo form_dropdown('doitac', $dt, (isset($_POST['doitac']) ? $_POST['doitac'] : $inv->doitac), 'id="doitac" data-placeholder="' . lang("select") . ' ' . lang("doitac") . '" class="form-control input-tip select" style="width:100%;"');
                                    ?>
								</div>
							</div>
							<div class="col-md-4">
...
<div class="modal" id="MdKhuyenMai" tabindex="-1" role="dialog" aria-labelledby="prKhuyenMai" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="editKhuyenMai"><?= lang('submit') ?></button>
            </div>
        </div>
    </div>
</div>
