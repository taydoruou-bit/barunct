...
<script>
    $(document).ready(function () {
        $('#GCData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getGiftCards/card') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null,{"bVisible": false},{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, null, {"mRender": fsd}, {"bSortable": false}]
        });
    });
</script>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="main-task-lhson">
            <a class="btn btn-primary btncls" href="<?php echo site_url('sales/add_gift_card'); ?>" data-toggle="modal" data-target="#myModal">
