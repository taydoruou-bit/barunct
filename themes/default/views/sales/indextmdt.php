...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('sales/getSalesTMDT' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
...
<div class="box">
    <div class="box-header no-print">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('Đơn hàng liên kết sàn TMĐT') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
