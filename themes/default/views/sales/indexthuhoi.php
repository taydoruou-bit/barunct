...
<script>
    $(document).ready(function () {
        oTable = $('#SLDataThuHoiLhson').dataTable({
            "aaSorting": [[0, "asc"], [1, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?=lang('all')?>"]],
            "iDisplayLength": <?=$Settings->rows_per_page?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?=site_url('sales/getThuHoi' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
		...
		jQuery("#dtFilter-filter-wrapper--SLDataThuHoiLhson-9").prepend(_lockq);
		
		jQuery("#_lockq").on("change", function(value){
			var This = jQuery(this);
			var selectedD = jQuery(this).val();
			jQuery("#dtFilter-filter--SLDataThuHoiLhson-9").val(selectedD);
			jQuery("#dtFilter-filter--SLDataThuHoiLhson-9").trigger("keyup");
		});
    });
	function inhoadon(){
		var val=0;
		var count=0;
		jQuery("#SLDataThuHoiLhson tbody tr").each(function(){
		...
		if(count==0){
			...
			if(val==0){
				...
				jQuery("#SLDataThuHoiLhson_wrapper a[href='<?php echo base_url();?>sales/printhoadon/"+val+"']").trigger("click");
			}
		}
	}
	...
	function giaohang(){
		...
		if(count==0){
			...
			if(val==0){
				...
				jQuery("#SLDataThuHoiLhson_wrapper a[href='<?php echo base_url();?>sales/add_delivery/"+val+"']").trigger("click");
			}
		}
	}
</script>
...
<div class="box">
    <div class="box-header no-print">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i>Danh sách thu hồi công nợ
        </h2>
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?=site_url('sales/addthuhoi')?>">
				<i class="fa fa-plus-circle"></i> Thêm thu hồi
			</a>
        ...
        <div class="row no-padding-lhson">
            <div class="col-lg-12"> 
                ...
                <div class="table-responsive">
                    <table id="SLDataThuHoiLhson" class="table table-bordered table-hover table-striped" style="width:100%">
                        <thead>
                        <tr>
