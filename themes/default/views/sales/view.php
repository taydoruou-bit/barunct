        ...
        <div class="row">
            <div class="col-lg-12">
                <?php if (!empty($inv->return_sale_ref) && $inv->return_id) {
                    echo '<div class="alert alert-info no-print"><p>Đơn hàng thu hồi: '.$inv->return_sale_ref;
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        <tr>
                            ...
                            if ($Settings->product_serial) {
                                echo '<th style="text-align:center; vertical-align:middle;">' . lang("serial_no") . '/Imei</th>';
                            }
                            ?>
							<?php
                            if ($Settings->baohanh) {
                                echo '<th style="text-align:center; vertical-align:middle;">' . lang("Bảo hành") . '</th>';
                            }
                            ?>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    ...
                                    if ($row->data_id_khuyenmai>0) {
                                        //get event name 
                                        $obj_km=$CI->site->getKhuyenmaiById($row->data_id_khuyenmai);
                                        if ($obj_km!=false) {
                                ...
                                <td style="width: 100px; text-align:center; vertical-align:middle;"><?= round($row->unit_quantity,2).' '.$row->product_unit_code; ?></td>
                                <?php
                                if ($Settings->product_serial) {
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                <div class="btn-group btn-group-justified">
					...
					<div class="btn-group">
                        <a href="<?= site_url('sales/printsalelhson/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary btn-success tip" title="<?= lang('print_hoadon') ?>">
                            <i class="fa fa-print"></i> <span class="hidden-sm hidden-xs"><?= lang('print_hoadon') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
