    ...
    <div class="modal-content">
        <div class="modal-body print">
            ...
            <div class="row padding10">
                <div class="<?php echo isset($inv)?'col-xs-5':'col-xs-12';?>">
            ...
            <div class="row">
				...
				<div class="col-sm-4 pull-right">
					<?php 
					$url_edit=site_url('sales/edit_payment/'.$payment->id);
					$url_xoa=site_url('sales/delete_payment/'.$payment->id);
					if(!$inv){
						$url_edit=site_url('sales/edit_payment_lhson/'.$payment->id);
						$url_xoa=site_url('sales/delete_payment_lhson/'.$payment->id);
					}
					?>
