            ...
            <div class="card">
                <div class="front">
                    ...
                    <div class="card-content white-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="353px" height="206px" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <image xlink:href="<?= $this->sma->save_barcode($gift_card->card_no, 'code128', 50, true, true); ?>" x="-10" y="135" height="50" width="353" />
                        </svg>
                    </div>
                ...
                <div class="back">
                    ...
                    <div class="card-content">
                        <div class="middle">
                            <?= '<img src="' . base_url('assets/uploads/logos/' . $Settings->logo2) . '" alt="' . $Settings->site_name . '" style="width:100%"/>'; ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
