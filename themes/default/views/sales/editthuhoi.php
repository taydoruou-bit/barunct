...
<div class="box">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i>Cập nhật thu hồi công nợ</h2>
		<div class="main-task-lhson themdonhang">
			<button type="submit" class="btn btn-primary btncls" name="edit_sale" id="edit_sale">
