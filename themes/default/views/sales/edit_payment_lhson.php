...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("sales/edit_payment_lhson/" . $payment->id, $attrib); ?>
        <div class="modal-body">
			
			<div class="col-md-12">
					<div class="form-group">					
							<?php
							echo form_input('customer_id', (isset($payment->id_ncc_id_kh) ? $payment->id_ncc_id_kh : ""), 'id="slcustomeraddpt" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control input-tip" style="width:100%;"');
							?>
					</div>
				</div>
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?= lang("Tên", "c_name"); ?>
                        <input name="c_name" type="text" id="c_name" value="<?=$payment->c_name;?>" class="form-control c_name"
                               required="required"/>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="c_phone" type="text" id="c_phone" value="<?=$payment->c_phone;?>" class="form-control c_phone"
                               />
                    </div> 
                </div>          
                <div class="form-group">
                    <?= lang("Địa chỉ", "c_address"); ?>
                    <?php echo form_textarea('c_address', $payment->c_address, 'class="form-control skip" id="c_address"'); ?>
                </div>
            ...
            <div class="form-group">
                <?= lang("note", "note"); ?>
                <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : $payment->note), 'class="form-control skip" id="note"'); ?>
            </div>

        </div>
        <div class="modal-footer">
            <?php echo form_submit('edit_payment_lhson', lang('edit_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		var $customer = $('#slcustomeraddpt');
		if(1==<?php echo isset($payment->id_ncc_id_kh)?1:0;?>){
			localStorage.setItem('slcustomeraddpt', '<?= $payment->id_ncc_id_kh ?>');
