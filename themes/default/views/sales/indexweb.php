...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('sales/getSalesWeb' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
...
<div class="box">
    <div class="box-header no-print">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('Đơn hàng API Woocommerce Wordpress') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
		...
		<div class="main-task-lhson">
			<a class="btn btn-primary btncls" href="<?=site_url('sales/add')?>">
             ...
             <a class="btn btn-primary btncls" href="/auth/SysnApiWoooOrdersV3">
                <i class="fa fa-arrows-v"></i> Đồng bộ đơn hàng WEB API WooCommerce
            </a>
