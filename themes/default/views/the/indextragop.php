...
<script>
    $(document).ready(function () {
        ...
        oTableSoQuy = $('#DoiData2').dataTable({
            "aaSorting": [[1, "desc"], [2, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?=lang('all')?>"]],
            "iDisplayLength": <?=$Settings->rows_per_page?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?=site_url('the/getThesTraGop');?>/'+$("#warehouse_soquy").val()+'/'+$("#start_date_soquy").val()+'/'+$("#end_date_soquy").val(),
            ...
            sSource='<?= site_url('the/getThesTraGop') ?>/'+kho+'/'+start_date+'/'+end_date;
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null,{"mRender": currencyFormat},{"mRender": currencyFormat},
            {
                "mRender": function ( data, type, row ) {
                    var f=parseFloat(row[5])-parseFloat(row[4]);
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    balance += parseFloat(aaData[aiDisplay[i]][5]-aaData[aiDisplay[i]][4]);
                }
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-credit-card"></i><?php echo ' Phương thức thanh toán trả góp';?>
        </h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="DoiData2" class="table table-bordered table-hover table-striped no-print">
                        <thead>
                        <tr>
                            ...
                            <th><?= lang("Mã"); ?></th>
                            <th><?= lang("Tên"); ?></th>
                            <th><?= lang("Tổng hóa đơn"); ?></th>
                            <th><?= lang("Đã thu hồi"); ?></th>
                            <th><?= lang("Tồn quỹ"); ?></th>
                            <th><?= lang("Ghi chú"); ?></th>
                            <th>#</th>
                        </tr>
