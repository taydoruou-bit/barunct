...
<script>
    $(document).ready(function () {
        oTable = $('#REData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('returns/getReturns' . ($warehouse_id ? '/' . $warehouse_id : '')); ?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null,null,null, null, null, {"mRender": currencyFormat}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}],
...
<?php if ($Owner || $GP['bulk_actions']) {
        echo form_open('returns/return_actions', 'id="action-form"');
    }
?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-random"></i><?php echo ' Thu hồi (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">                
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=site_url('returns')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                                foreach ($warehouses as $warehouse) {
                                        echo '<li><a href="' . site_url('returns/index/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                    }
                                ?>
                        </ul>
                    </li>
				...
				<div class="main-task-lhson">
					<a class="btn btn-primary btncls" href="<?= site_url('returns/add') ?>">
