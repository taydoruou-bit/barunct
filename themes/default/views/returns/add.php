...
<div class="box lhson_nhapkho_add">
	 <?php
		...
		echo form_open_multipart("returns/add", $attrib);
		?>
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i>Thêm thu hồi</h2>
		<div class="main-task-lhson nhapkho">
			<button type="submit" class="btn btn-primary btncls" name="add_return" id="add_return">
