...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#REData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('returns/getReturnsBaoCao?v=1' . $v); ?>',
            ...
            "aoColumns": [{"mRender": fld}, null,null,null, null, null, {"mRender": currencyFormat}, {"bSortable": false,"mRender": attachment}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-random"></i> Báo cáo khách trả hàng tổng quan
        </h2>
		...
		<div class="box-icon">
            <ul class="btn-tasks">
				...
				<li class="dropdown"><a target="_blank" href="<?php echo site_url('returns/baocaochitiet');?>" id="chitiet" class="tip" title="Báo cáo chi tiết"><i
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				<div id="form">
				<?php echo form_open("returns/baocao"); ?>
						<div class="row">
							<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('returns/getReturnsBaoCao/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('returns/getReturnsBaoCao/0/xls/?v=1'.$v)?>";
            return false;
        });
