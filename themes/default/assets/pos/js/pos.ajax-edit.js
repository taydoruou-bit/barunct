...
function loadItems() {
    ...
    if (localStorage.getItem('positems')) {
        ...
        if (pos_settings.remote_printing != 1) {
            ...
            var pos_head2 = '</h4><p class="text-left">Khách: '+$('#select2-chosen-1').text()+'<br>'+$('#reference_note').val()+'<br>Nhân viên: '+username+'<br>T: '+date(site.dateFormats.php_ldate, time)+'</p></span>';
