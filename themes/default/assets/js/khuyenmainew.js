...
function loadItems() {
    ...
    if (localStorage.getItem('quitems')) {
        ...
        jQuery(sortedItems).each(function () {
			...
			var giakhuyenmai = item.row.promo_price?item.row.promo_price:0;
			
			var sub_quantity = item.row.sub_quantity?item.row.sub_quantity:1;
            ...
            var sel_opt = '';
			item_price=unit_price=item.row.price;
            ...
            tr_html += '<td class="text-right"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' + row_no + '" value="' + formatDecimal(item_price) + '"><input class="ruprice" name="unit_price[]" id="priceok_' + row_no + '" type="hidden" value="' + unit_price + '"><input class="realuprice" name="real_unit_price[]" type="hidden"  value="' + item.row.real_unit_price + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(item_price) + '</span></td>';
			
			
			tr_html += '<td class="text-right"><input class="form-control input-sm giakhuyenmai" name="giakhuyenmai[]" type="text" id="giakhuyenmai_' + row_no + '" value="'+formatDecimal(giakhuyenmai)+'"></td>';
            
			
            tr_html += '<td><input class="form-control text-center kmquan" tabindex="'+((site.settings.set_focus == 1) ? an : (an+1))+'" name="kmquan[]" type="text" value="'+formatDecimal(sub_quantity)+'" data-id="' + row_no + '" data-item="' + item_id + '" id="kmquan_' + row_no + '" ></td>';
