...
function loadItems() {
    ...
    if (localStorage.getItem('quitems')) {
        ...
        jQuery(sortedItems).each(function () {
			...
			var giakhuyenmai = item.row.promo_price;
            ...
            tr_html += '<td><input class="form-control text-center kmquan" tabindex="'+((site.settings.set_focus == 1) ? an : (an+1))+'" name="kmquan[]" type="text" value="0" data-id="' + row_no + '" data-item="' + item_id + '" id="kmquan_' + row_no + '" onChange="checkKM(\'' + row_no + '\');"></td>';
