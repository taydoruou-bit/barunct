                ...
                $.each(tax_rates, function () {
                    if(this.id == pr_tax){
                        if (this.type == 1) {
                            ...
                            if (poitems[item_id].row.tax_rate == 0) {
    ...
    if (localStorage.getItem('poitems')) {
        ...
        $.each(sortedItems, function () {
            ...
            var supplier = localStorage.getItem('posupplier'), belong = false;
                ...
                unit_cost = formatDecimal(unit_cost+item_discount+item_chieckhau, 4);
                var sel_opt = '';
                $.each(item.options, function () {
			...
			if (site.settings.chiec_khau == 1) {
                tr_html += '<td class="text-right"><input class="form-control input-sm rchiec_khau" name="product_chieckhau[]" type="hidden" id="discountck_' + row_no + '" value="' + i_chiec_khauv2 + '"><span class="text-right schieckhau text-danger" id="sdiscount_' + row_no + '">' + formatMoney(0 - (item_chieckhau * item_qty)) + '</span></td>';
            }
            if (site.settings.tax1 == 1) {
